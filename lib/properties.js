...
export const ETAPAS = ["captado", "fotos_drive", "infos", "no_site"];
...
function normalize(list) {
  return (Array.isArray(list) ? list : []).map((p, i) => {
    ...
    return {
      ...
      // etapa: funil interno (remapeia valores antigos). Legado desconhecido => "no_site" (já estão no ar).
      etapa: (() => { const e = ETAPA_ALIASES[p.etapa] || p.etapa; return ETAPAS.includes(e) ? e : "no_site"; })(),
