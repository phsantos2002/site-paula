export default function WhatsAppFloat({ contact = {} }) {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-[9999] flex h-14 w-14 items-center justify-center rounded-full bg-whatsapp shadow-float transition-transform duration-200 hover:scale-105"
    >
